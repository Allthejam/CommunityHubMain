...
import { ArrowLeft, LifeBuoy, Pointer, Edit, Banknote, ShieldCheck, CheckCircle, Printer, ShieldAlert } from "lucide-react";
...
export default function StripeInstructionsPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card variant="destructive" className="bg-destructive/5 border-destructive/40">
                <CardHeader>
                    <CardTitle className="flex items-center gap-3 text-destructive">
                        <ShieldAlert className="h-6 w-6" />
                        Important: After a Leadership Handover
                    </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    <p>
                        If you have recently taken over as the leader of this community, it is crucial that you update the financial details.
                        <strong className="block mt-1">All subscription revenue will continue to be paid to the previous leader's connected Stripe account until you connect your own.</strong>
                    </p>
                    <Alert>
                        ...
                        <AlertDescription>
                            <ul className="list-disc pl-5 space-y-1">
                                <li>
                                    <strong>Immediate Action Required:</strong> If the previous leader was using a personal bank account, it is a matter of urgency that you contact them to arrange for the transfer of any community funds and connect a new account immediately.
                                </li>
                                <li>
                                    <strong>Community Bank Accounts:</strong> If the previous leader was using a dedicated bank account for the community, the urgency is less, but you should still update the Stripe connection to your own authorized account as soon as possible.
                                </li>
                                <li>
                                    <strong>Disclaimer:</strong> The Community Hub platform is not responsible for the management or transfer of funds between previous and current community leaders. It is your responsibility to ensure this transition is handled correctly.
                                </li>
                            </ul>
                        </AlertDescription>
                    </Alert>
                    <p>Follow the steps below to connect your new account.</p>
                </CardContent>
            </Card>
