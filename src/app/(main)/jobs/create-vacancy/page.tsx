...
export default function CreateVacancyPage() {
  ...
  const handleCapture = () => {
    if (videoRef.current && canvasRef.current) {
        ...
        setCustomLogo(canvas.toDataURL('image/jpeg', 0.9));
        setIsCameraOpen(false);
    }
  };
    ...
    return (
        <div className="space-y-8 max-w-4xl mx-auto py-8">
             <div>
                ...
                <h1 className="text-3xl font-bold tracking-tight font-headline flex items-center gap-2"><FileText /> Post a Job Vacancy</h1>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-2xl">Vacancy Details</CardTitle>
                    <CardDescription>
                ...
                <CardContent className="grid gap-6 py-4">
                            ...
                            <div className="space-y-2">
                                ...
                                {customLogo ? (
                                    <div className="relative w-32 h-32">
                                        <Image src={customLogo} alt="Logo Preview" fill className="rounded-md object-contain border bg-muted" />
                                        <Button 
                                            type="button" 
                                            variant="destructive" 
                                            size="icon" 
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button type="button" variant="outline" size="sm" onClick={() => setIsCameraOpen(true)}><Camera className="mr-2 h-4 w-4" /> Take Picture</Button>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="space-y-4 pt-4 border-t">
                        <Label className="text-base font-semibold flex items-center gap-2">
                            <Banknote className="h-5 w-5" /> Salary / Pay Structure
                        </Label>
                                    ...
                                    <SelectContent>
                                        {payFrequencies.map((freq) => (
                                            <SelectItem key={freq.value} value={freq.value}>
                                                {freq.label.charAt(0).toUpperCase() + freq.label.slice(1)}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                                </Select>
                    ...
                    <div className="space-y-4 pt-4 border-t">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="linkedin-url">LinkedIn Application URL</Label>
                            <div className="relative">
                                <Linkedin className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                                <Input id="linkedin-url" type="url" placeholder="https://www.linkedin.com/jobs/view/..." value={linkedinApplyUrl} onChange={e => setLinkedinApplyUrl(e.target.value)} className="pl-10"/>
                            </div>
                        </div>
                        <div className="grid gap-2">
                ...
                <CardFooter>
                    <Button onClick={handlePostVacancy} disabled={isSubmittingVacancy} className="w-full sm:w-auto">
