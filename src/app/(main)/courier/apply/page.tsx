                            ...
                            <div className="space-y-4 pt-4 border-t">
                                ...
                                <div className="space-y-2">
                                 ...
                                 <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">Please take a clear photo of your face. This helps us confirm you are the person on the license.</p>
                                    {selfieImage ? (
                                        <div className="relative w-48 h-32">
                                        ...
                                        <div className="flex gap-2">
                                            <Button type="button" variant="outline" onClick={() => selfieFileInputRef.current?.click()}><Upload className="mr-2" /> Upload</Button>
                                            <input type="file" ref={selfieFileInputRef} onChange={(e) => handleFileChange(e, 'selfie')} accept="image/*" className="hidden" />
