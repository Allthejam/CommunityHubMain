                        ...
                        <TableBody>
                            {categories && categories.length > 0 ? (
                                categories.map((category) => (
                                    <TableRow key={category.id} className="block md:table-row">
                                        <TableCell className="block md:table-cell" data-label="Category">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-sm text-muted-foreground mt-1 line-clamp-2 md:line-clamp-none">{category.description}</p>
                                                </div>
                                            </div>
                                        </TableCell>
                                        <TableCell className="block md:table-cell md:text-center" data-label="Topics">{category.topics || 0}</TableCell>
                                        <TableCell className="block md:table-cell md:text-center" data-label="Posts">{category.posts || 0}</TableCell>
                                    </TableRow>
                                ))
                            ) : (
                                <TableRow>
