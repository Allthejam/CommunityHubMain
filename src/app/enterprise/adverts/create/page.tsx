...
const CreateAdvertPageContent = () => {
    ...
    const backLink = isOwnerAd ? '/admin/adverts' : '/enterprise/adverts';
    ...
    React.useEffect(() => {
        if (advertData) {
            setHeadline(advertData.headline || "");
    ...
    const handlePreview = () => {
        ...
        try {
            sessionStorage.setItem('advertPreviewData', JSON.stringify(adData));
             let previewUrl = `/enterprise/adverts/create/preview?type=${advertType}`;
    ...
    const handleSaveDraft = async () => {
        ...
        const adData = {
            id: advertId, // Pass ID for updates
            type: advertType,
            title: headline,
            headline: headline,
            shortDescription: shortDescription,
        ...
        if (result.success) {
            toast({ title: advertId ? "Changes Saved" : "Draft Saved", description: "Your advert has been saved." });
        ...
        <div className="space-y-8">
            <div>
                ...
                <h1 className="text-3xl font-bold tracking-tight font-headline">
                    {advertId ? 'Edit Campaign' : 'Create Campaign'} (Step 2 of 4)
                </h1>
                 ...
                 <CardFooter className="flex-wrap gap-2">
                    <Button onClick={handlePreview}>
                     ...
                     <Button variant="outline" onClick={handleSaveDraft} disabled={isSavingDraft}>
                        ...
                        {advertId ? 'Save Changes' : 'Save as Draft'}
                    </Button>
                </CardFooter>
            </Card>
        </div>
