...
function SearchContent() {
  ...
  const handleSearchSubmit = (e: React.FormEvent) => {
    ...
    if (clean) {
      router.push(`/demo/search?q=${encodeURIComponent(clean)}`);
    } else {
  ...
  const handleSuggestedSearch = (suggestion: string) => {
    ...
    router.push(`/demo/search?q=${encodeURIComponent(suggestion)}`);
  };
          ...
          <form onSubmit={handleSearchSubmit} className="w-full relative max-w-2xl">
            <div className="relative flex items-center">
              ...
              {searchTerm && (
                <button
                  type="button"
                  onClick={() => { setSearchTerm(''); setActiveQuery(''); router.push('/demo/search'); }}
                                ...
                                {isUnclaimed ? (
                                  <>
                                    ...
                                    <Button variant="outline" size="sm" asChild>
                                      <Link href="/demo/home" className="text-xs font-semibold gap-1">
                                  ...
                                  <>
                                    ...
                                    <Button variant="outline" size="sm" asChild>
                                      <Link href="/demo/communities" className="text-xs font-semibold gap-1">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {matchedBusinesses.map((biz) => {
                          ...
                          const townName = communityNamesMap.get(commId) || biz.communityName || 'Oakridge & DemoVille';
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {matchedEvents.map((evt) => {
                          const townName = communityNamesMap.get(evt.communityId) || 'Oakridge & DemoVille';
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {matchedWhatsOn.map((w) => {
                          const townName = communityNamesMap.get(w.communityId) || 'Oakridge & DemoVille';
                            ...
                            <CardHeader className="py-3">
                              <div className="flex items-start justify-between gap-3">
                                ...
                                <Button variant="outline" size="sm" className="h-7 text-xs font-bold shrink-0" asChild>
                                  <Link href="/demo/news">Read Story</Link>
                                </Button>
                              </div>
                            </CardHeader>
                          </Card>
