...
export default function GalleryPage() {
  ...
  const businessQuery = useMemoFirebase(
    () => (user ? query(collection(db, "businesses"), where("ownerId", "==", user.uid)) : null),
    [user, db]
  );
  ...
  const galleryLimit = businessPlan?.galleryImages ?? 10;
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage the images that appear on your business profile page.
          </p>
        </div>
        ...
        <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose which business gallery you want to manage.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
