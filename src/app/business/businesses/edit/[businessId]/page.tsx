            ...
            <TabsContent value="page1">
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">This is your primary community where your business is based. Revenue share is attributed here. To change this, you must create a new business listing in the desired community.</p>
                    ...
                    <Card className="border-border/70">
                        ...
                        <CardContent className="space-y-6">
                            <div className="p-4 border rounded-lg bg-muted/50">
                                ...
                                <p className="text-green-700 dark:text-green-400 text-sm">https://my-community-hub.co.uk/businesses/{businessName?.toLowerCase().replace(/\s+/g, '-') || 'your-business'}</p>
             ...
             <TabsContent value="page3">
                <CardContent className="space-y-4">
                    ...
                    {pageThreeType === 'custom' ? (
                        ...
                        <div>Meeting Minutes Editor will go here</div>
                    )}
                </CardContent>
            </TabsContent>
        </Tabs>
