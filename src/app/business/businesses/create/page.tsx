...
import { Building2, ArrowLeft, Info, RefreshCcw, PlusCircle, Trash2, Loader2, Save, Eye, ShieldAlert, Search, ImagePlus, X, Upload, AlertTriangle } from "lucide-react";
...
export default function CreateBusinessPage() {
    ...
    const [isAccommodation, setIsAccommodation] = React.useState(initialFormState.isAccommodation);
    const [sellsRestrictedProducts, setSellsRestrictedProducts] = React.useState(initialFormState.sellsRestrictedProducts);
    ...
    const [pageTwoIntro, setPageTwoIntro] = React.useState(initialFormState.pageTwoIntro);
    ...
    const getFormData = () => ({
        businessName, businessCategory, isAccommodation, sellsRestrictedProducts, website, socialMedia, contactEmail, contactNumber,
        shortDescription, longDescription, pageTwoIntro, pageTwoContent, addresses, bannerImage, logoImage, additionalCommunities,
    ...
    const handleSave = async (status: 'Pending Approval' | 'Draft') => {
        if (!user || !userProfile?.communityId) {
             toast({ title: "Not Authenticated", description: "You must be logged in to create a business.", variant: "destructive" });
             return;
        }
        ...
        try {
            ...
            if (result.success) {
                toast({
                    title: status === 'Draft' ? "Draft Saved!" : "Business Submitted!",
    ...
    const handleResetForm = () => {
        ...
        setIsAccommodation(initialFormState.isAccommodation);
        setSellsRestrictedProducts(initialFormState.sellsRestrictedProducts);
        ...
        setPageTwoIntro(initialFormState.pageTwoIntro);
    ...
    <div className="space-y-8">
        <div>
            ...
            <p className="text-muted-foreground">
                Fill in the details below to submit your new business for approval.
            </p>
        </div>
      <Alert>
        ...
        <CardContent className="space-y-6">
            <div className="space-y-4 pt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-2 rounded-lg border p-4">
                        ...
                        <div>
                            <Label htmlFor="showPageThree">Show Page Three (Contact/Minutes)</Label>
                            <p className="text-xs text-muted-foreground">Display your custom contact/minutes page.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-2 rounded-lg border p-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Check this if your business sells or intends to sell restricted products.</p>
                        </div>
                    </div>
                </div>
                {sellsRestrictedProducts && (
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="grid gap-2">
                    ...
                    <Input id="name" value={businessName} onChange={(e) => setBusinessName(e.target.value)} placeholder="e.g., The Corner Cafe" />
                </div>
                <div className="grid gap-2">
                    <Label htmlFor="category">
                        {isAccommodation ? 'Accommodation Type *' : 'Business Category *'}
                    </Label>
            ...
            <Separator />
            <div className="space-y-4">
                <h3 className="text-lg font-medium">Business Address(es)</h3>
            ...
            <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Your business will be primarily listed in your registered community. Revenue share is attributed here.</p>
            ...
            <Separator />
             ...
             <Card className="border-border/70">
                <CardHeader>
                    ...
                    <CardDescription>
                    Improve your ranking and how your business page will appear in search engines results.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
            ...
            <Accordion type="multiple" className="w-full">
                ...
                <AccordionItem value="page-three">
                    <AccordionTrigger>Page Three Content</AccordionTrigger>
                     <AccordionContent className="pt-4 space-y-4">
                        <RadioGroup value={pageThreeType} onValueChange={(val) => setPageThreeType(val as 'custom' | 'minutes')} className="flex gap-4">
                    ...
                    <AccordionContent className="pt-4">
                        <div className="space-y-4">
                            ...
                            {Object.keys(openingHours).map((day) => (
                                <div key={day} className="grid grid-cols-1 md:grid-cols-[100px_1fr_1fr_1fr_auto] items-center gap-x-4 gap-y-2 p-2 rounded-md hover:bg-muted/50">
