...
export const businesses = [
  {
    ...
    logoImage: 'https://picsum.photos/seed/business2/400/200',
    status: 'Approved',
    phone: '555-0102',
  ...
  { id: 9, businessName: 'The Art Corner', businessCategory: 'arts-crafts', shortDescription: 'Art supplies for all ages and skill levels.', logoImage: 'https://picsum.photos/seed/business9/400/200', status: 'Approved' },
  { id: 12, businessName: 'Pet Palace', businessCategory: 'pet-services', shortDescription: 'Grooming and supplies for your furry friends.', logoImage: 'https://picsum.photos/seed/business12/400/200', status: 'Approved' },
  { id: 13, businessName: 'The Gadget Spot', businessCategory: 'electronics', shortDescription: 'Latest tech and gadgets. Expert advice.', logoImage: 'https://picsum.photos/seed/business13/400/200', status: 'Approved' },
  { id: 14, businessName: 'Chic Boutique', businessCategory: 'clothing', shortDescription: 'Curated fashion for the modern individual.', logoImage: 'https://picsum.photos/seed/business14/400/200', status: 'Approved' },
  { id: 15, businessName: 'The Local Butcher', businessCategory: 'food', shortDescription: 'Locally sourced, high-quality meats.', logoImage: 'https://picsum.photos/seed/business15/400/200', status: 'Approved' },
  { id: 16, businessName: 'Fit Hub', businessCategory: 'fitness', shortDescription: '24/7 gym with state-of-the-art equipment.', logoImage: 'https://picsum.photos/seed/business16/400/200', status: 'Approved' },
  { id: 18, businessName: "The Toy Chest", businessCategory: "toys-hobbies", shortDescription: "Classic toys and games for all ages.", logoImage: 'https://picsum.photos/seed/business18/400/200', status: 'Approved' },
  { id: 20, businessName: "Fresh Blooms", businessCategory: "florist", shortDescription: "Beautiful bouquets for any occasion.", logoImage: 'https://picsum.photos/seed/business20/400/200', status: 'Approved' },
  { id: 21, businessName: "The Jewellery Box", businessCategory: "jewellery", shortDescription: "Handcrafted jewellery and repair services.", logoImage: 'https://picsum.photos/seed/business21/400/200', status: 'Approved' },
  { id: 23, businessName: "Sole Mates", businessCategory: "shoe-store", shortDescription: "Stylish and comfortable footwear for the whole family.", logoImage: 'https://picsum.photos/seed/business23/400/200', status: 'Approved' },
  { id: 25, businessName: "Cycle Works", businessCategory: "bike-shop", shortDescription: "Bicycle sales, repairs, and rentals.", logoImage: 'https://picsum.photos/seed/business25/400/200', status: 'Approved' },
  { id: 26, businessName: "The Vinyl Stop", businessCategory: "music-store", shortDescription: "New and vintage vinyl records.", logoImage: 'https://picsum.photos/seed/business26/400/200', status: 'Approved' },
  { id: 27, businessName: "The Spice Merchant", businessCategory: "food", shortDescription: "Exotic spices, herbs, and teas from around the world.", logoImage: 'https://picsum.photos/seed/business27/400/200', status: 'Approved' },
  { id: 29, businessName: "The Optical View", businessCategory: "optician", shortDescription: "Eyewear and eye care specialists.", logoImage: 'https://picsum.photos/seed/business29/400/200', status: 'Approved' },
  { id: 30, businessName: "Knot & Grain", businessCategory: "furniture", shortDescription: "Handcrafted wooden furniture.", logoImage: 'https://picsum.photos/seed/business30/400/200', status: 'Approved' },
  { id: 31, businessName: "The Computer Cellar", businessCategory: "electronics", shortDescription: "PC and Mac repairs and sales.", logoImage: 'https://picsum.photos/seed/business31/400/200', status: 'Approved' },
  { id: 32, businessName: "Glow Up", businessCategory: "beauty-salon", shortDescription: "Full-service beauty and nail salon.", logoImage: 'https://picsum.photos/seed/business32/400/200', status: 'Approved' },
  { id: 33, businessName: "The Fish Monger", businessCategory: "food", shortDescription: "Fresh, sustainably sourced seafood daily.", logoImage: 'https://picsum.photos/seed/business33/400/200', status: 'Approved' },
  { id: 40, businessName: "Ink & Quill", businessCategory: "stationery", shortDescription: "Fine pens, paper, and office supplies.", logoImage: 'https://picsum.photos/seed/business40/400/200', status: 'Approved' },
  { id: 41, businessName: "Vogue Apparel", businessCategory: "clothing", shortDescription: "Latest trends in men's and women's fashion.", logoImage: 'https://picsum.photos/seed/business41/400/200', status: 'Approved' },
  { id: 42, businessName: "Little Sprouts", businessCategory: "clothing", shortDescription: "Adorable and durable clothing for kids.", logoImage: 'https://picsum.photos/seed/business42/400/200', status: 'Approved' },
  { id: 43, businessName: "Gemstone Gems", businessCategory: "jewellery", shortDescription: "Exquisite, handcrafted gemstone jewelry.", logoImage: 'https://picsum.photos/seed/business43/400/200', status: 'Approved' },
  { id: 44, businessName: "Timepieces & Co.", businessCategory: "jewellery", shortDescription: "Luxury watches and expert repair services.", logoImage: 'https://picsum.photos/seed/business44/400/200', status: 'Approved' },
  { id: 45, businessName: "Tech Forward", businessCategory: "electronics", shortDescription: "Your one-stop shop for all consumer electronics.", logoImage: 'https://picsum.photos/seed/business45/400/200', status: 'Approved' },
  { id: 46, businessName: "Gamer's Galaxy", businessCategory: "electronics", shortDescription: "Video games, consoles, and accessories.", logoImage: 'https://picsum.photos/seed/business46/400/200', status: 'Approved' },
  { id: 47, businessName: "Toyland Adventures", businessCategory: "toys-hobbies", shortDescription: "A world of fun for kids of all ages.", logoImage: 'https://picsum.photos/seed/business47/400/200', status: 'Approved' },
  { id: 48, businessName: "Model Crafters", businessCategory: "toys-hobbies", shortDescription: "Kits and supplies for hobbyist model builders.", logoImage: 'https://picsum.photos/seed/business48/400/200', status: 'Approved' },
  { id: 49, businessName: "The Cheese Board", businessCategory: "food", shortDescription: "A curated selection of fine cheeses and accompaniments.", logoImage: 'https://picsum.photos/seed/business49/400/200', status: 'Approved' },
  { id: 50, businessName: "The Green Grocer", businessCategory: "food", shortDescription: "Fresh, organic, and locally sourced produce.", logoImage: 'https://picsum.photos/seed/business50/400/200', status: 'Approved' },
  { id: 51, businessName: 'Outdoor Gear Exchange', businessCategory: 'outdoors', shortDescription: 'Gear for hiking, camping, and climbing.', logoImage: 'https://picsum.photos/seed/business51/400/200', status: 'Approved' },
  { id: 52, businessName: 'The Lens Cap', businessCategory: 'photography', shortDescription: 'Cameras, lenses, and photo printing services.', logoImage: 'https://picsum.photos/seed/business52/400/200', status: 'Approved' },
  { id: 53, businessName: 'The Daily Grind', businessCategory: 'food', shortDescription: 'Artisanal coffee, pastries, and light lunches.', logoImage: 'https://picsum.photos/seed/business53/400/200', status: 'Approved' },
  { id: 54, businessName: 'The Corner Bistro', businessCategory: 'food', shortDescription: 'Cozy spot for European-inspired dishes.', logoImage: 'https://picsum.photos/seed/business54/400/200', status: 'Approved' },
  { id: 55, businessName: "Mike's Auto Repair", businessCategory: 'automotive', shortDescription: 'Reliable repairs and maintenance for all vehicles.', logoImage: 'https://picsum.photos/seed/business55/400/200', status: 'Approved' },
  { id: 56, businessName: 'Wellness Studio', businessCategory: 'health-fitness', shortDescription: 'Yoga, pilates, and meditation classes.', logoImage: 'https://picsum.photos/seed/business56/400/200', status: 'Approved' },
  { id: 57, businessName: 'Uptown Threads', businessCategory: 'clothing', shortDescription: 'Vintage and consignment fashion finds.', logoImage: 'https://picsum.photos/seed/business57/400/200', status: 'Approved' },
  { id: 58, businessName: 'Silver & Gold', businessCategory: 'jewellery', shortDescription: 'Custom engagement rings and fine jewelry.', logoImage: 'https://picsum.photos/seed/business58/400/200', status: 'Approved' },
  { id: 59, businessName: 'Sound Advice', businessCategory: 'electronics', shortDescription: 'High-fidelity audio equipment and home theaters.', logoImage: 'https://picsum.photos/seed/business59/400/200', status: 'Approved' },
  { id: 60, businessName: 'Playtime Emporium', businessCategory: 'toys-hobbies', shortDescription: 'Educational toys and board games.', logoImage: 'https://picsum.photos/seed/business60/400/200', status: 'Approved' },
  { id: 61, businessName: 'The Olive Branch', businessCategory: 'food', shortDescription: 'Artisanal olive oils and imported goods.', logoImage: 'https://picsum.photos/seed/business61/400/200', status: 'Approved' },
  { id: 62, businessName: 'The Board Room', businessCategory: 'toys-hobbies', shortDescription: 'Board game cafe with a large library of games.', logoImage: 'https://picsum.photos/seed/business62/400/200', status: 'Approved' },
  { id: 63, businessName: 'Future Threads', businessCategory: 'clothing', shortDescription: 'Sustainable and ethically made apparel.', logoImage: 'https://picsum.photos/seed/business63/400/200', status: 'Approved' },
  { id: 64, businessName: 'The Sparkling Gem', businessCategory: 'jewellery', shortDescription: 'Affordable and stylish fashion jewellery.', logoImage: 'https://picsum.photos/seed/business64/400/200', status: 'Approved' },
  { id: 65, businessName: 'Mobile Solutions', businessCategory: 'electronics', shortDescription: 'Phone repairs and accessories.', logoImage: 'https://picsum.photos/seed/business65/400/200', status: 'Approved' },
  { id: 66, businessName: 'Puzzle Palace', businessCategory: 'toys-hobbies', shortDescription: 'Jigsaw puzzles for all ages and skill levels.', logoImage: 'https://picsum.photos/seed/business66/400/200', status: 'Approved' },
  { id: 67, businessName: 'Butcher Block', businessCategory: 'food', shortDescription: 'Artisan butcher with local and exotic meats.', logoImage: 'https://picsum.photos/seed/business67/400/200', status: 'Approved' }
];

export const mockCourierBusiness = {
  id: 'mock-courier-99',
  businessName: 'Become the Community Courier',
  businessCategory: 'courier',
  shortDescription: 'Handle local deliveries for your community and get a free business profile. Apply now!',
  logoImage: 'https://i.postimg.cc/Yq3GqC68/truck.png',
  status: 'Approved',
  leaderCount: 0,
};
...
export const mockCommunityAdverts = [
    { id: 1, businessId: 'mock-biz-1', title: '2-for-1 Pizza', business: 'Pizza Palace', image: getImage('advert1')?.imageUrl, shortDescription: 'Buy one pizza, get one free every Tuesday!', fullDescription: '<p>Come on down to Pizza Palace on Tuesdays for our amazing 2-for-1 deal. This applies to all our large pizzas!</p>', link: '#', status: 'Active', startDate: { toDate: () => new Date() } },
    { id: 2, businessId: 'mock-biz-2', title: 'Fresh Blooms', business: 'The Flower Shop', image: getImage('advert2')?.imageUrl, shortDescription: '20% off all bouquets this week.', fullDescription: '<p>Brighten up your home with our beautiful spring bouquets. Get 20% off all week.</p>', link: '#', status: 'Active', startDate: { toDate: () => new Date() } },
    { id: 3, businessId: 'mock-biz-3', title: 'Morning Coffee Deal', business: 'The Daily Grind', image: getImage('advert3')?.imageUrl, shortDescription: 'Coffee and a pastry for just £3 before 11am.', fullDescription: '<p>Start your day right with our morning deal. Any regular coffee and a pastry for just £3.</p>', link: '#', status: 'Active', startDate: { toDate: () => new Date() } },
    { id: 4, businessId: 'mock-biz-4', title: 'Handmade Jewellery', business: 'The Craft Corner', image: getImage('advert1')?.imageUrl, shortDescription: 'Unique, locally made jewellery.', fullDescription: '<p>Discover our collection of handmade necklaces, bracelets, and earrings. Perfect for a special gift.</p>', link: '#', status: 'Active', startDate: { toDate: () => new Date() } },
    { id: 5, businessId: 'mock-biz-5', title: 'Book Sale', business: 'Page Turners', image: getImage('advert2')?.imageUrl, shortDescription: 'Buy two books, get one free!', fullDescription: '<p>Stock up on your summer reading with our big book sale. Buy any two books and get a third one for free.</p>', link: '#', status: 'Active', startDate: { toDate: () => new Date() } },
];
