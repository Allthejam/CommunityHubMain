            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 text-center md:text-left">
                    ...
                    {isClient ? (
                        <Dialog open={isCommunityDialogOpen} onOpenChange={setIsCommunityDialogOpen}>
                            <DialogTrigger asChild>
                                <button className="text-sm hover:underline text-muted-foreground">Find a Community</button>
                            </DialogTrigger>
                            <DialogContent className="sm:max-w-lg">
                                <DialogHeader>
                                    <DialogTitle>Visit Another Community</DialogTitle>
                        ...
                        <span className="text-sm text-muted-foreground">Find a Community</span>
                    )}
                ...
                <nav className="flex flex-col space-y-2 items-center md:items-start">
                     {isClient ? (
                        <Dialog>
                            <DialogTrigger asChild>
                                <button className="text-sm hover:underline text-muted-foreground">Guidelines</button>
                            </DialogTrigger>
                            <DialogContent className="max-w-2xl grid grid-rows-[auto,1fr,auto] p-0 max-h-[85vh]">
                                <DialogHeader className="p-6 pb-2 border-b">
                                    <DialogTitle>Platform Guidelines</DialogTitle>
                                </DialogHeader>
                                <ScrollArea className="h-full">
                                    <div className="p-6">
                                        <LegalDocumentDisplay documentId="sTVGwGp2rooSSQjgKj8O" />
                                    </div>
                                </ScrollArea>
                    ...
                    {isClient ? (
                        <Dialog>
                            <DialogTrigger asChild>
                                <button className="text-sm hover:underline text-muted-foreground">Privacy Policy</button>
                            </DialogTrigger>
                            <DialogContent className="max-w-2xl grid grid-rows-[auto,1fr,auto] p-0 max-h-[85vh]">
                                <DialogHeader className="p-6 pb-2 border-b">
                                ...
                                <ScrollArea className="h-full">
                                    <div className="p-6">
                                        <LegalDocumentDisplay documentId="dU2bv8ImneCZsDbXzwYl" />
                                    </div>
                                </ScrollArea>
                                <DialogFooter className="p-6 pt-4 border-t">
                                    <DialogClose asChild>
